...
# Define Ultralytics GitHub assets maintained at  https://mirror.ghproxy.com/https://github.com/ultralytics/assets
...
def attempt_download_asset(file, repo='ultralytics/assets', release='v0.0.0'):
    ...
    if file.exists():
        ...
        if str(file).startswith(('http:/', 'https:/')):  # download
            ...
            safe_download(url=f' https://mirror.ghproxy.com/https://github.com/{repo}/releases/download/{release}/{name}', file=file, min_bytes=1E5)
            ...
            if name in assets:
                safe_download(url=f' https://mirror.ghproxy.com/https://github.com/{repo}/releases/download/{tag}/{name}', file=file, min_bytes=1E5)
